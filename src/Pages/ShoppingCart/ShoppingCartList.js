                                ...
                                <li>
                                    ...
                                    <div className="savingProductInfo">
                                        <div className="savingProductInfoMain">
                                            <div className="savingProductInfoTitle">{cartData.name}</div>
                                            <div className="savingProductInfoAmount"></div>
                                            <div className="savingProductInfoAllPrice">KRW {cartData.price} </div>
                                        </div>
                                        <div className="savingProductInfoLeft">
                                            <div className="savingProductInfoLeftBox">
                                                <div className="savingProductInfoPrice">KRW {cartData.price} </div>
                                                <div className="savingProductInfoOption">[옵션:{cartData.color}]</div>
                                            </div>
