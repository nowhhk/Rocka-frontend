...
class SignUp extends Component {
  ...
  phoenNumber = (e) => {
    if (
      this.state.contactTwo.length === 4 &&
      this.state.contactThree.length === 4
    ) {
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td><input type="text" name="pwConform" onChange={this.handleInput} /></td>
              </tr>
            </tbody>
          </table>
        </article>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="userInfoContact" onChange={this.phoenNumber}>
                  ...
                  <span>-</span><input type="text" className="userInfoInputBox" name="contactTwo" onChange={this.handleInput} /><span>-</span><input type="text" className="userInfoInputBox" name="contactThree" onChange={this.handleInput} />
                </td>
              </tr>
              <tr>
                <th>주소</th>
